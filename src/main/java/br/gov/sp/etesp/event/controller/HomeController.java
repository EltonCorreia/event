...
public class HomeController {
	...
	public String abrirHome(Model model) {
		List<EventoEntities> eventos = repository.findAll();
		model.addAttribute("eventos", eventos);
		return "home";
	}
	
	@PostMapping("/adicionar")
	public ModelAndView adicionarEvento(EventoEntities evento) {
		evento.setDtCadastro(LocalDate.now());
	...
	@GetMapping("/encerrar/{id}")
		...
		EventoEntities evento = repository.findById(id).get();
